...
export const DEFAULT_SITE: SiteContent = {
  ...
  services: [
    ...
    { id: 's2', name: 'Musculación', description: 'Sala de pesas con equipamiento profesional y asesoramiento', icon: 'dumbbell', order: 2 },
    { id: 's3', name: 'Yoga', description: 'Clases de yoga para cuidar cuerpo y mente', icon: 'lotus', order: 3 },
